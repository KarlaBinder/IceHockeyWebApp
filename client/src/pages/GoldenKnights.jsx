  ...
  const handleSubmit = async (e) => {
    ...
    const isLineupAlreadySaved = existingLineups.some((existingLineup) => {
      return (
        ...
        JSON.stringify(existingLineup.forwardLineup) ===
          JSON.stringify(data.forwardLineup) &&
        JSON.stringify(existingLineup.defensiveLineup) ===
          JSON.stringify(data.defensiveLineup)
      );
    });
